...
- 产品功能待办：`docs/product/feature_backlog.md`
- 产品功能注册表：`docs/product/feature_registry.md`
...
- 稳定功能定义：`docs/product/features/<feature-slug>/README.md`
- 稳定功能需求：`docs/product/features/<feature-slug>/requirements.md`
...
- 功能级验收标准：`docs/product/features/<feature-slug>-acceptance.md`
- Legacy 全局验收标准索引：`docs/product/acceptance_criteria.md`
- Legacy 全局追溯矩阵：`docs/product/traceability_matrix.md`
