...
- Every test case includes Stage Scope ID, FR, Spec, AC, Traceability Row, Gap, test layer, automation status, script path, command, result status, and evidence report.
