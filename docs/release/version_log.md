...
| 0.2.0-p0-commercial-readiness | TBD | P0 commercial subscription readiness: provider verification boundary, Flutter subscription integration, release preflight scripts, provider/store evidence gates | High | Pause store rollout, preserve payment/audit records, revert commercial client/backend changes together, rerun release readiness and provider sandbox/internal gates |
