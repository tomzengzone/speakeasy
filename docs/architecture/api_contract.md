...
| P02-API-005 | `POST /goal-autopilot/checkpoints` records weekly/biweekly checkpoint results, updates forecast and emits a plan update signal. It must reject unsupported checkpoint tasks and task types outside the server-owned task library. It must not claim official IELTS/TOEFL certification or guaranteed score. | P02-AUTO-FR-005, P02-AUTO-FR-007, P02-AUTO-FR-008, P02-FUC-FR-002 |
