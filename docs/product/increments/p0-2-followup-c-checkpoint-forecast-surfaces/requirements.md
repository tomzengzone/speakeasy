...
- S000 只能声明 documentation-chain ready；S001 只能声明 ProgressForecast hardening local evidence ready；不得声明 S002-S007 已实现、Followup-C release-ready 或 Product Base-ready。
