...
## 状态
S001 forecast hardening、S002 checkpoint task library、S003 checkpoint-to-plan、S004 backend projection、S005 surface propagation and S006 surface downgrade locally implemented and tested / S007 implementation gated - 本文件定义 `p0-2-followup-c-checkpoint-forecast-surfaces` 的需求边界，并把 Followup-C 拆分为 S000-S007 小粒度 slice。S000 文档链、AC-to-TC 规划、traceability 入口和独立审核已完成；S001 已完成 ProgressForecast model hardening 的本地代码、contract 和 TC-P02-FUC-001..003 测试证据；S002 已完成 Checkpoint cadence/task library 的本地代码、contract 和 TC-P02-FUC-004..006 测试证据；S003 已完成 Checkpoint-to-plan update 的本地代码、contract、TC-P02-FUC-007..009 测试证据和独立审核；S004 已完成 backend-owned goal-progress projection 的本地代码、contract、TC-P02-FUC-010..012 测试证据和独立审核；S005 已完成 Home/Queue/Wiki surface propagation 的本地 Flutter 代码、UX/test contract、TC-P02-FUC-013..016 测试证据和独立审核；S006 已完成 surface deletion/unavailable downgrade 的本地 backend data-governance、account deletion、Flutter downgrade/cache cleanup 代码和 TC-P02-FUC-017..019 测试证据；S007 尚未进入代码实现。Followup-C is not release-ready；Product Base merge is not approved。
...
- S000 只能声明 documentation-chain ready；S001 只能声明 ProgressForecast hardening local evidence ready；S002 只能声明 checkpoint cadence/task-library local evidence ready；S003 只能声明 checkpoint-to-plan local evidence ready；S004 只能声明 backend projection local evidence ready；S005 只能声明 Home/Queue/Wiki surface propagation local evidence ready；S006 只能声明 deletion/unavailable downgrade local evidence ready；不得声明 S007 已实现、Followup-C release-ready 或 Product Base-ready。
