...
## 状态
S001、S002、S003、S004、S005、S006 and S007 acceptance locally executed - 本文件基于 Followup-C requirements 和 spec 定义验收标准。S000 文档链验收已通过 TC-P02-FUC-000；S001 ProgressForecast model hardening 已通过 TC-P02-FUC-001..003；S002 Checkpoint cadence and task library 已通过 TC-P02-FUC-004..006；S003 Checkpoint-to-plan update 已通过 TC-P02-FUC-007..009；2026-06-11 XCB-005 checkpoint evidence-boundary regression 已追加 TC-P02-FUC-023；S004 backend goal-progress projection 已通过 TC-P02-FUC-010..012；S005 Home/Queue/Wiki surface propagation 已通过 TC-P02-FUC-013..016；S006 Surface deletion/unavailable downgrade 已通过 TC-P02-FUC-017..019；S007 performance、coverage、traceability script、report evidence 和 independent review 已通过 TC-P02-FUC-020..022。Followup-C is locally complete for S001-S007. Followup-C is not release-ready and Product Base merge is not approved。
...
| P02-FUC-S003 | Checkpoint-to-plan update | AC-P02-FUC-003 | TC-P02-FUC-007..009, TC-P02-FUC-023 | Passed locally: checkpoint result, forecast update, stale/replan, replay audit, control/recovery tests and XCB-005 trusted audio_ref boundary regression |
...
- Given checkpoint input includes `audio_ref`, the backend must accept only user-owned validated `media://audio/...` references from the existing Media upload and AI Gateway trust boundary; local paths, URLs, cross-user refs and unvalidated refs must fail closed before checkpoint persistence.
- Given checkpoint input includes client `score_hint`, it may be retained only as candidate input and must not raise confidence, ETA, claim guard, mastery or completion facts without accepted server-owned checkpoint evidence.
