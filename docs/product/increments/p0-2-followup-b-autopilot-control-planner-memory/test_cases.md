...
## 状态
AC-to-TC gate complete / S006 replay-performance-traceability executed - 本文件定义 Followup-B 测试用例库。TC-P02-FUB-001、TC-P02-FUB-002、TC-P02-FUB-003 和 TC-P02-FUB-004 已有 backend/frontend control slice 本地通过证据；TC-P02-FUB-002 已关闭当前 S001 control、control idempotency、redacted audit、retention policy snapshot 和 account-deletion cleanup 范围；TC-P02-FUB-005 和 TC-P02-FUB-006 已关闭 S002-A notification eligibility policy 范围；TC-P02-FUB-007 和 TC-P02-FUB-008 已关闭 S002-B notification outbox lifecycle/replay 范围；TC-P02-FUB-009 和 TC-P02-FUB-010 已关闭 S003 missed-day recovery planner 范围；TC-P02-FUB-011 和 TC-P02-FUB-012 已关闭 S004 item-level MemoryCurvePolicy 范围；TC-P02-FUB-013 和 TC-P02-FUB-014 已关闭 S005 mastery transition / AI candidate-only explanation 范围；TC-P02-FUB-015、TC-P02-FUB-016 和 TC-P02-FUB-017 已关闭 S006 replay fixture、p95 performance、coverage 和 Followup-B traceability script 范围。Followup-B is not release-ready；Product Base merge is not approved。
...
| Execution status | Executed through S006 - control source/update/pause/resume/backend validation/data-governance/deletion-cleanup, Flutter control binding, S002-A eligibility policy, S002-B notification outbox lifecycle/replay, S003 missed-day recovery planner, S004 item-level memory, S005 mastery transition and S006 replay/performance/coverage/traceability gates executed locally |
| Evidence report | `docs/reports/test_report.md#2026-06-05-p02-followup-b-s006-replay-performance-traceability` |
...
| P02-FUB-SLICE-005 | L0-L5 mastery transition and AI candidate-only explanation | AC-P02-FUB-007 | TC-P02-FUB-013..014 | FUB-FIX-007 | Executed for S005 mastery transition; TC-P02-FUB-013/014 passed |
| P02-FUB-SLICE-006 | Replay, performance, coverage and final review gates | AC-P02-FUB-008 | TC-P02-FUB-015..017 | FUB-FIX-008, FUB-FIX-009 | Executed for S006 replay fixture, p95 budgets, coverage and traceability script; TC-P02-FUB-015..017 passed |
...
| TC-P02-FUB-013 | P02-SI-003, P02-SI-011 | P02-PG-001, P02-PG-003 | P02-FUB-FR-007 | P02-FUB-SPEC-007 | AC-P02-FUB-007 | P02-FUB-TR-007 | P02-FUB-GAP-007 | unit | automated | `backend/src/test/java/com/speakeasy/goal/MasteryTransitionPolicyTest.java`; `backend/src/test/java/com/speakeasy/GoalAutopilotControllerTest.java#tcP02Fub013MasteryTransitionAuditIsReadOnlyAndReplayable` | `cd backend && JAVA_HOME=/opt/homebrew/opt/openjdk@17 mvn -q -Dmaven.repo.local=.m2/repository -Dtest=MasteryTransitionPolicyTest,GoalAutopilotControllerTest test` | passed | `docs/reports/test_report.md#2026-06-05-p02-followup-b-s005-mastery-transition` |
| TC-P02-FUB-014 | P02-SI-003, P02-SI-011 | P02-PG-001, P02-PG-003 | P02-FUB-FR-007 | P02-FUB-SPEC-007 | AC-P02-FUB-007 | P02-FUB-TR-007 | P02-FUB-GAP-007 | ai-eval | automated | `docs/ai_runtime/ai_eval_cases.md`; `backend/src/test/java/com/speakeasy/goal/MasteryTransitionPolicyTest.java#rejectsAiPersistentMasteryFields` | `cd backend && JAVA_HOME=/opt/homebrew/opt/openjdk@17 mvn -q -Dmaven.repo.local=.m2/repository -Dtest=MasteryTransitionPolicyTest test` | passed | `docs/reports/test_report.md#2026-06-05-p02-followup-b-s005-mastery-transition` |
| TC-P02-FUB-015 | P02-SI-001, P02-SI-002, P02-SI-003, P02-SI-004, P02-SI-005, P02-SI-009, P02-SI-010, P02-SI-011 | P02-PG-001, P02-PG-002, P02-PG-003, P02-PG-004, P02-PG-005 | P02-FUB-FR-008 | P02-FUB-SPEC-008 | AC-P02-FUB-008 | P02-FUB-TR-008 | P02-FUB-GAP-008 | release-check | automated | `backend/src/test/java/com/speakeasy/goal/GoalAutopilotReplayFixtureTest.java` | `cd backend && JAVA_HOME=/opt/homebrew/opt/openjdk@17 mvn -q -Dmaven.repo.local=.m2/repository -Dtest=GoalAutopilotReplayFixtureTest test` | passed | `docs/reports/test_report.md#2026-06-05-p02-followup-b-s006-replay-performance-traceability` |
| TC-P02-FUB-016 | P02-SI-001, P02-SI-002, P02-SI-003, P02-SI-004, P02-SI-005, P02-SI-009, P02-SI-010, P02-SI-011 | P02-PG-001, P02-PG-002, P02-PG-003, P02-PG-004, P02-PG-005 | P02-FUB-FR-008 | P02-FUB-SPEC-008 | AC-P02-FUB-008 | P02-FUB-TR-008 | P02-FUB-GAP-009 | release-check | automated | `backend/src/test/java/com/speakeasy/goal/GoalAutopilotControlPerformanceTest.java` | `cd backend && JAVA_HOME=/opt/homebrew/opt/openjdk@17 mvn -q -Dmaven.repo.local=.m2/repository -Dtest=GoalAutopilotControlPerformanceTest test` | passed | `docs/reports/test_report.md#2026-06-05-p02-followup-b-s006-replay-performance-traceability` |
| TC-P02-FUB-017 | P02-SI-001, P02-SI-002, P02-SI-003, P02-SI-004, P02-SI-005, P02-SI-009, P02-SI-010, P02-SI-011 | P02-PG-001, P02-PG-002, P02-PG-003, P02-PG-004, P02-PG-005 | P02-FUB-FR-008 | P02-FUB-SPEC-008 | AC-P02-FUB-008 | P02-FUB-TR-008 | P02-FUB-GAP-010 | release-check | automated | `scripts/check_p0_2_followup_b_traceability.py`; supporting path: `scripts/check_p0_2_goal_autopilot_coverage.py` | `python3 scripts/check_p0_2_followup_b_traceability.py && python3 scripts/check_p0_2_goal_autopilot_coverage.py` | passed | `docs/reports/test_report.md#2026-06-05-p02-followup-b-s006-replay-performance-traceability` |
...
| AC-P02-FUB-002 | TC-P02-FUB-003, TC-P02-FUB-004 | TC-P02-FUB-015, TC-P02-FUB-017 | Executed for backend pause/resume/update-control, Flutter server-state binding and S006 replay/traceability support |
| AC-P02-FUB-003 | TC-P02-FUB-005, TC-P02-FUB-006 | TC-P02-FUB-015, TC-P02-FUB-017 | Executed for S002-A notification eligibility policy and S006 replay/traceability support |
| AC-P02-FUB-004 | TC-P02-FUB-007, TC-P02-FUB-008 | TC-P02-FUB-015, TC-P02-FUB-017 | Executed for S002-B outbox lifecycle, redacted projection, replay audit, deletion cleanup and S006 replay/traceability support |
| AC-P02-FUB-005 | TC-P02-FUB-009, TC-P02-FUB-010 | TC-P02-FUB-015, TC-P02-FUB-017 | Executed for S003 recovery planner and S006 replay/traceability support |
| AC-P02-FUB-006 | TC-P02-FUB-011, TC-P02-FUB-012 | TC-P02-FUB-015, TC-P02-FUB-017 | Executed for S004 item-level memory policy and S006 replay/traceability support |
| AC-P02-FUB-007 | TC-P02-FUB-013, TC-P02-FUB-014 | TC-P02-FUB-015, TC-P02-FUB-017 | Executed for S005 mastery transition, AI candidate-only explanation guardrails and S006 replay/traceability support |
| AC-P02-FUB-008 | TC-P02-FUB-015, TC-P02-FUB-016, TC-P02-FUB-017 | TC-P02-FUB-001..014 | Executed for S006 replay, performance, coverage and traceability gates |
