...
## 状态
AC-to-TC gate complete / S002-A notification eligibility executed - 本文件定义 Followup-B 测试用例库。TC-P02-FUB-001、TC-P02-FUB-002、TC-P02-FUB-003 和 TC-P02-FUB-004 已有 backend/frontend control slice 本地通过证据；TC-P02-FUB-002 已关闭当前 S001 control、control idempotency、redacted audit、retention policy snapshot 和 account-deletion cleanup 范围；TC-P02-FUB-005 和 TC-P02-FUB-006 已关闭 S002-A notification eligibility policy 范围，覆盖 reason precedence、quiet hours 跨午夜、permission/consent/entitlement/quota/stale/missing-plan 和 Flutter no-false-completion 展示。未实现的 notification outbox 记录治理继续归属 TC-P02-FUB-007/008；TC-P02-FUB-007..017 仍为 planned，其中 TC-P02-FUB-017 的 Followup-B 专用 traceability 脚本尚不存在，必须在 completion slice 中创建或由批准的等价脚本替代。
...
| Execution status | Partial - control source/update/pause/resume/backend validation/data-governance/deletion-cleanup, Flutter control binding and S002-A notification eligibility policy executed; remaining outbox/recovery/memory/mastery/replay/performance/coverage gates planned |
| Evidence report | `docs/reports/test_report.md#2026-06-05-p02-followup-b-s002-a-notification-eligibility-policy` |

## Implementation Slice Test Routing
| Slice ID | Scope | AC | TC | Fixture IDs | Execution state |
| --- | --- | --- | --- | --- | --- |
| P02-FUB-SLICE-001 | UserAutopilotControl source、pause/resume/update-control | AC-P02-FUB-001, AC-P02-FUB-002 | TC-P02-FUB-001..004 | FUB-FIX-001, FUB-FIX-002 | Partial executed - backend/frontend routed control subset and current control data-governance TC passed; notification outbox governance remains S002 |
| P02-FUB-SLICE-002 | Notification eligibility and scheduler/outbox | AC-P02-FUB-003, AC-P02-FUB-004 | TC-P02-FUB-005..008 | FUB-FIX-003, FUB-FIX-004 | Partial executed - S002-A eligibility policy TC-P02-FUB-005/006 passed; scheduler/outbox lifecycle and replay remain TC-P02-FUB-007/008 planned |
| P02-FUB-SLICE-003 | Missed-day recovery planner | AC-P02-FUB-005 | TC-P02-FUB-009..010 | FUB-FIX-005 | Planned - compress/defer/replace and no-overdue-stacking tests required |
| P02-FUB-SLICE-004 | Item-level MemoryCurvePolicy | AC-P02-FUB-006 | TC-P02-FUB-011..012 | FUB-FIX-006 | Planned - item-level due, overlearning, interleaving, budget and replay tests required |
...
| TC-P02-FUB-007 | P02-SI-010 | P02-PG-003, P02-PG-005 | P02-FUB-FR-004 | P02-FUB-SPEC-004 | AC-P02-FUB-004 | P02-FUB-TR-004 | P02-FUB-GAP-004 | integration | planned | `backend/src/test/java/com/speakeasy/goal/NotificationOutboxServiceTest.java` | `cd backend && JAVA_HOME=/opt/homebrew/opt/openjdk@17 mvn -q -Dmaven.repo.local=.m2/repository -Dtest=NotificationOutboxServiceTest test` | planned | `docs/reports/test_report.md#p02-followup-b-planned` |
| TC-P02-FUB-008 | P02-SI-010 | P02-PG-003, P02-PG-005 | P02-FUB-FR-004 | P02-FUB-SPEC-004 | AC-P02-FUB-004 | P02-FUB-TR-004 | P02-FUB-GAP-004 | integration | planned | `backend/src/test/java/com/speakeasy/goal/NotificationOutboxReplayTest.java` | `cd backend && JAVA_HOME=/opt/homebrew/opt/openjdk@17 mvn -q -Dmaven.repo.local=.m2/repository -Dtest=NotificationOutboxReplayTest test` | planned | `docs/reports/test_report.md#p02-followup-b-planned` |
| TC-P02-FUB-009 | P02-SI-001, P02-SI-004, P02-SI-005, P02-SI-009 | P02-PG-002, P02-PG-003 | P02-FUB-FR-005 | P02-FUB-SPEC-005 | AC-P02-FUB-005 | P02-FUB-TR-005 | P02-FUB-GAP-005 | unit | planned | `backend/src/test/java/com/speakeasy/goal/MissedDayRecoveryPlannerTest.java` | `cd backend && JAVA_HOME=/opt/homebrew/opt/openjdk@17 mvn -q -Dmaven.repo.local=.m2/repository -Dtest=MissedDayRecoveryPlannerTest test` | planned | `docs/reports/test_report.md#p02-followup-b-planned` |
| TC-P02-FUB-010 | P02-SI-001, P02-SI-004, P02-SI-005, P02-SI-009 | P02-PG-002, P02-PG-003 | P02-FUB-FR-005 | P02-FUB-SPEC-005 | AC-P02-FUB-005 | P02-FUB-TR-005 | P02-FUB-GAP-005 | integration | planned | `backend/src/test/java/com/speakeasy/goal/GoalAutopilotRecoveryControllerTest.java` | `cd backend && JAVA_HOME=/opt/homebrew/opt/openjdk@17 mvn -q -Dmaven.repo.local=.m2/repository -Dtest=GoalAutopilotRecoveryControllerTest test` | planned | `docs/reports/test_report.md#p02-followup-b-planned` |
| TC-P02-FUB-011 | P02-SI-001, P02-SI-002, P02-SI-011 | P02-PG-001, P02-PG-003 | P02-FUB-FR-006 | P02-FUB-SPEC-006 | AC-P02-FUB-006 | P02-FUB-TR-006 | P02-FUB-GAP-006 | unit | planned | `backend/src/test/java/com/speakeasy/goal/MemoryCurvePolicyTest.java` | `cd backend && JAVA_HOME=/opt/homebrew/opt/openjdk@17 mvn -q -Dmaven.repo.local=.m2/repository -Dtest=MemoryCurvePolicyTest test` | planned | `docs/reports/test_report.md#p02-followup-b-planned` |
| TC-P02-FUB-012 | P02-SI-001, P02-SI-002, P02-SI-011 | P02-PG-001, P02-PG-003 | P02-FUB-FR-006 | P02-FUB-SPEC-006 | AC-P02-FUB-006 | P02-FUB-TR-006 | P02-FUB-GAP-006 | integration | planned | `backend/src/test/java/com/speakeasy/goal/MemoryCurveReplayTest.java` | `cd backend && JAVA_HOME=/opt/homebrew/opt/openjdk@17 mvn -q -Dmaven.repo.local=.m2/repository -Dtest=MemoryCurveReplayTest test` | planned | `docs/reports/test_report.md#p02-followup-b-planned` |
...
| --- | --- | --- | --- |
| AC-P02-FUB-001 | TC-P02-FUB-001, TC-P02-FUB-002 | TC-P02-FUB-017 | Executed for S001 control source, validation, internal governance export snapshot, redacted audit and deletion cleanup; future notification outbox records remain TC-P02-FUB-007/008 |
...
| AC-P02-FUB-004 | TC-P02-FUB-007, TC-P02-FUB-008 | TC-P02-FUB-015, TC-P02-FUB-017 | Covered planned |
| AC-P02-FUB-005 | TC-P02-FUB-009, TC-P02-FUB-010 | TC-P02-FUB-015, TC-P02-FUB-017 | Covered planned |
| AC-P02-FUB-006 | TC-P02-FUB-011, TC-P02-FUB-012 | TC-P02-FUB-015, TC-P02-FUB-017 | Covered planned |
...
- TC-P02-FUB-007..017 test scripts are implemented in their planned paths or mapped to approved equivalent paths.
- Notification scheduler/outbox records and their data-governance coverage are implemented and executed through TC-P02-FUB-007/008.
