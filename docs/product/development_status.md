...
- V2 Capability registry：`docs/product/feature_registry.md`
...
- P0.2 Followup-D definition/requirements/spec/AC/TC/traceability：`docs/product/increments/p0-2-followup-d-release-gate-hardening/definition.md`, `docs/product/increments/p0-2-followup-d-release-gate-hardening/requirements.md`, `docs/product/increments/p0-2-followup-d-release-gate-hardening/spec.md`, `docs/product/increments/p0-2-followup-d-release-gate-hardening/acceptance.md`, `docs/product/increments/p0-2-followup-d-release-gate-hardening/test_cases.md`, `docs/product/increments/p0-2-followup-d-release-gate-hardening/traceability.md`
- P0.2 Followup-E definition/phase-1 requirements/spec/phase-2 contracts/phase-3 AC-TC-traceability/planning implementation plan：`docs/product/increments/p0-2-followup-e-speaking-diagnostic-production/definition.md`, `docs/product/increments/p0-2-followup-e-speaking-diagnostic-production/requirements.md`, `docs/product/increments/p0-2-followup-e-speaking-diagnostic-production/spec.md`, `docs/product/increments/p0-2-followup-e-speaking-diagnostic-production/acceptance.md`, `docs/product/increments/p0-2-followup-e-speaking-diagnostic-production/test_cases.md`, `docs/product/increments/p0-2-followup-e-speaking-diagnostic-production/traceability.md`, `docs/product/increments/p0-2-followup-e-speaking-diagnostic-production/implementation_plan.md`, `docs/domain/domain_schema.md`, `docs/architecture/api_contract.md`, `docs/architecture/data_flow.md`, `docs/ai_runtime/prompt_contract.md`, `docs/ai_runtime/llm_output_schema.md`, `docs/ai_runtime/fallback_strategy.md`, `docs/ai_runtime/ai_eval_cases.md`, `docs/ux/screen_spec.md`；phase-2 contracts 已修正后通过独立复核，phase-3 AC/TC/traceability 已通过独立审核；所有 Followup-E code/test/OpenAPI/generated execution evidence 均仍为 planned。Full Followup-E remains incomplete；release/Product Base/paid AI evidence 仍未完成。
...
40. 2026-06-06 P0.2 Followup-C S000 文档链验证、S001 forecast hardening、S002 checkpoint task library、S003 checkpoint-to-plan update、S004 backend projection、S005 surface propagation、S006 surface deletion/unavailable downgrade 和 S007 quality gates 本地实现/测试/独立审核已完成：TC-P02-FUC-001/002/003/004/005/006/007/008/009/010/011/012/013/014/015/016/017/018/019/020/021/022 passed，OpenAPI/generated Dart drift 已同步，AI deterministic no-provider fallback、candidate-only claim guard、checkpoint task-selection deterministic N/A、checkpoint-to-plan backend-owned replay signal、progress projection backend-owned source-of-truth 边界、Home/Queue/Wiki Flutter projection surface 边界、backend downgrade reason traceability、cached stale projection cleanup、p95 performance、changed-code coverage 和 dedicated traceability script 边界已记录。`P02-FOLLOWUP-C-S007-QUALITY-GATES-20260606` records TC-P02-FUC-020/021/022 passed；`P02-FOLLOWUP-C-S007-OPENAPI-NULLABLE-CLEANUP-20260606` records Redocly nullable `$ref` warning cleanup and OpenAPI hash `d8b492b07c98e948caf0b5912744f05fa6dcd4b76f97f0ece04dc9778df7da0f`。Followup-C is locally complete for S001-S007。Followup-C is not release-ready and Product Base merge is not approved。
41. 2026-06-06 P0.2 Followup-D S001 backend runtime gate 本地实现/测试/独立审核已完成：TC-P02-FUD-001/002 passed，覆盖 backend feature flag、kill switch、fail-closed mutations、read/projection disabled downgrade、redacted audit evidence、OpenAPI 503 contract 和 generated Dart hash `0918bcf90cbc08198be7273e07fd18aa0471e06ba32f9cee21185105814780b2`。Followup-D S001 is locally complete for backend/API runtime gate only；at S001 close, S002 Flutter rollback and S003-S011 commercial/data/ops/release gates remained planned。Current S002 evidence is recorded in item 42。Followup-D is not release-ready and Product Base merge is not approved。
42. 2026-06-06 P0.2 Followup-D S002 Flutter runtime rollback 本地实现/测试/独立审核已完成：TC-P02-FUD-003/004 passed，覆盖 Flutter disabled/unavailable entry rollback、Home/Queue/Wiki/Panel unavailable surfaces、cached projection replacement、backend unavailable 503 handling、frontend source-of-truth guard 和 no-local goal/plan/forecast/checkpoint/ETA/quota/release fallback。Followup-D S002 is locally complete for Flutter rollback only；current S003 evidence is recorded in item 43。Followup-D is not release-ready and Product Base merge is not approved。
43. 2026-06-06 P0.2 Followup-D S003 entitlement/free-paid depth 本地实现/测试/独立审核已完成：TC-P02-FUD-005/006 passed，覆盖 backend server-owned entitlement depth policy、free/default limited、active paid full only with support/quota/cost、expired/grace limited、revoked/refunded/unknown blocked、partial/unsupported support override、OpenAPI `GoalEntitlementDepth` contract、generated Dart hash `9269bc0c15413f57377629ee3c142fb41d4180518c5f93e81cbfadfcc59a7bd3` 和 Flutter service-owned entitlement limitation display/no-local entitlement inference。Followup-D S003 is locally complete for entitlement depth only；S004-S011 commercial/data/ops/release gates remain planned。Followup-D is not release-ready and Product Base merge is not approved。
44. 2026-06-06 P0.2 Followup-D S004 usage reservation/quota 本地实现/测试/独立审核已完成：TC-P02-FUD-007/008 passed，覆盖 full-depth plan/checkpoint usage reserve before deterministic costly execution、success commit exactly once、failed checkpoint release/no-charge、quota blocked before new plan writes、idempotent retry no double charge、same idempotency key different payload typed conflict、OpenAPI `UsageReservation` source/idempotency/provider event ref contract 和 generated Dart hash `38dd8133c0551dc019eaf56fe8ccde3016db5f3180f9f578e85714ba5aae61b2`。Followup-D S004 is locally complete for usage/quota/idempotency only；current S005 evidence is recorded in item 45。Followup-D is not release-ready and Product Base merge is not approved。
45. 2026-06-06 P0.2 Followup-D S005 cost telemetry/AI fallback 本地实现/测试/独立审核已完成：TC-P02-FUD-009/010 passed，覆盖 deterministic no-provider cost metrics、policy rejection metrics、quota rejection metric persistence、free fallback 不创建 entitlement facts、dashboard `fallback_reason`、AI candidate forbidden persistent fields rejection、OpenAPI `AiCostMetric.fallback_reason` / `deterministic_no_provider` status 和 generated Dart hash `3196a97f38da3d2f01044cbeab242fa3a78c449ff4bb92fa4ccce549fc96686c`。Followup-D S005 is locally complete for cost telemetry/AI fallback only；current S006 evidence is recorded in item 46。Followup-D is not release-ready and Product Base merge is not approved。
46. 2026-06-06 P0.2 Followup-D S006 quota downgrade 本地实现/测试/独立审核已完成：TC-P02-FUD-011/012 passed，覆盖 stable `quota_exhausted` / `entitlement_required` / `cost_budget_limited` backend reasons、full-depth plan/checkpoint/ETA/projection block and downgrade、OpenAPI stable reason contract/generated Dart hash `fa2f5c368a83abbc6e24b182046af875b25856ce3af9756a861ff66794b464eb`、Flutter Home/Queue/Wiki/Panel stale full-depth cleanup 和 no-local quota/entitlement inference。Followup-D S006 is locally complete for quota downgrade only；S007-S011 data governance、consent、telemetry、drift/release gates remain planned。Followup-D is not release-ready and Product Base merge is not approved。
47. 2026-06-07 P0.2 Followup-D S007 data governance 本地实现/测试/独立审核已完成：TC-P02-FUD-013/014 passed，覆盖 P0.2 goal/autopilot/progress/usage/cost data-family redacted export、retention rule coverage、raw transcript/audio/provider/notification/idempotency sensitive payload omission、account deletion cleanup、AI metric redacted user-hash cleanup 和 redacted audit proof。Followup-D S007 is locally complete for data governance backend evidence only；current S008 evidence is recorded in item 48。Followup-D is not release-ready and Product Base merge is not approved。
48. 2026-06-07 P0.2 Followup-D S008 consent/privacy UX 本地实现/测试/独立审核已完成：TC-P02-FUD-015 passed，覆盖 Goal Autopilot privacy/consent surface、backend `notification_consent` / `reminder_eligibility` / projection state rendering、notification consent withdrawal blocking reminder prompts、data-use/export/delete/retention copy、sensitive payload omission copy、commercial/release promise copy contract、stale privacy state cleanup、Flutter goal_autopilot 回归和 coverage gate。Followup-D S008 is locally complete for consent/privacy UX only；current S009 evidence is recorded in item 49。Followup-D is not release-ready and Product Base merge is not approved。
49. 2026-06-07 P0.2 Followup-D S009 telemetry health/error/funnel metrics 本地实现/测试/独立审核已完成：TC-P02-FUD-016/017 passed，覆盖 redacted `goal_autopilot_metric_events` schema、goal intake/diagnostic/plan/control/next action/action completion/checkpoint/projection/provider fallback/quota/kill-switch metric events、stable blocked reason codes、telemetry write failure non-blocking fallback audit、data-governance export family、account deletion metric cleanup、backend migration/compile/regression 和 coverage gate。Followup-D S009 is locally complete for telemetry only；current S010 evidence is recorded in item 50。Followup-D is not release-ready and Product Base merge is not approved。
50. 2026-06-07 P0.2 Followup-D S010 contract/traceability/release drift gates 本地实现/测试/独立审核已完成：`P02-FOLLOWUP-D-S010-DRIFT-GATES-20260607` records TC-P02-FUD-018/019 passed，覆盖 dedicated Followup-D traceability checker、OpenAPI/generated Dart drift、release checklist/rollback plan sync、release readiness fixture wiring、strict release readiness expected-blocked preservation、reports/development_status sync 和 forbidden release claim guard。Followup-D S010 is locally complete for drift gates only；current S011 evidence is recorded in item 51。Followup-D is not release-ready and Product Base merge is not approved。
...
目标：在不扩大 P0.1 范围的前提下，判断 `p0-1-expression-automation-training` increment 的本地训练闭环是否可以作为稳定能力合入 Product Base。
...
4. `P01-REG-001`：仅核验归属 increment 已批准的 V2 Primary Capability / Affected Capabilities 分类，并保留 paid AI voice release residual 指向 `commercial-ai-provider-hardening`；不得从 registry 推导行为或更新交付状态。

### Next - P0.2 Followup-B 后续实现路由
- P0.2 目标驱动自动带练：原始三个 increment 已完成 requirements/spec/acceptance/test_cases/traceability 和本地 deterministic slice evidence；Followup-A 已完成本地实现审核；Followup-B 已完成 requirements/spec/acceptance/test_cases、traceability、Domain、API/OpenAPI/generated client sync、AI runtime 和 UX 合同审核，并已完成 backend/frontend UserAutopilotControl control slice、S002-A notification eligibility policy、S002-B notification outbox lifecycle/replay、S003 missed-day recovery planner、S004 item-level MemoryCurvePolicy、S005 mastery transition 与 S006 replay/performance/coverage/traceability gates 的本地执行证据回写。Followup-C 已完成 S000 document chain、S001 forecast hardening、S002 checkpoint task library、S003 checkpoint-to-plan update、S004 backend projection、S005 Home/Queue/Wiki surfaces、S006 downgrade/data governance 和 S007 performance/final traceability 本地证据；Followup-C is locally complete for S001-S007。Followup-C is not release-ready and Product Base merge is not approved。Followup-D S000 文档链、S001 backend/API runtime gate、S002 Flutter rollback、S003 entitlement depth、S004 usage reservation/quota、S005 cost telemetry/AI fallback、S006 quota downgrade、S007 data governance、S008 consent/privacy UX、S009 telemetry、S010 drift gates 和 S011 final review 已本地通过；Followup-D is not release-ready and Product Base merge is not approved。
